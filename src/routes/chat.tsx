  ...
  head: () => ({
    meta: [
      { title: "AI Chat — Ompular" },
      {
        name: "description",
        content:
          "Ask once, get answers from google/gemini-3.1-pro-preview, google/gemini-3.7-flash and openai/gpt-5.4-mini at the same time — then pick the best.",
      },
      { property: "og:title", content: "Triple AI Chat — Ompular" },
      {
        property: "og:description",
        content: "Three AI models answer simultaneously. You pick the winner.",
      },
  ...
  const send = async () => {
    ...
    try {
      ...
      notify({
        ...
        preview: "Compare google/gemini-3.1-pro-preview, google/gemini-3.7-flash and openai/gpt-5.4-mini, then pick your favourite.",
      });
        ...
        <div className="chat-messages">
          {entries.length === 0 && (
            <div className="chat-welcome">
              ...
              <p>
                google/gemini-3.1-pro-preview, google/gemini-3.7-flash and openai/gpt-5.4-mini all
